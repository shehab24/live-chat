...
class Live_Chat
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Live_Chat_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Live_Chat_Loader. Orchestrates the hooks of the plugin.
	 * - Live_Chat_i18n. Defines internationalization functionality.
	 * - Live_Chat_Admin. Defines all hooks for the admin area.
	 * - Live_Chat_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Live_Chat_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
