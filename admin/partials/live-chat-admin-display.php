 ...
 *
 * @package    Live_Chat
 * @subpackage Live_Chat/admin/partials
 */
?>

<!-- This file should primarily consist of HTML with a little bit of PHP. -->
<main class="content" style="max-width:100% !important ; max-height:850px !important;">
    <div class="container  p-0" style="max-width:95% !important ;">


        <div class="card w-100" style="max-width:100% !important ;height:100% !important; ">
            <div class="row g-0">
                <div class="col-12 col-md-12 col-lg-5 col-xl-3 border-right left_side">

                    <div class="px-4 d-none d-md-block search_box">
                ...
                <div class="col-12 col-lg-7 col-xl-9">
                    ...
                    <div class="flex-grow-0 py-3 px-4 border-top">
                        <div class="input-group">
                            <textarea class="form-control" id="admin_send_input" placeholder="Type your message"></textarea>
                            <button class="btn btn-primary px-2" id="admin_send_btn">Send</button>
                        </div>
                    </div>
